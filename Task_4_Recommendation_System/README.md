...
![Machine Learning](https://img.shields.io/badge/ML-Recommendation_System-7C3AED?style=for-the-badge)
...
The objective of this project is to build a recommendation system that suggests suitable job roles to users based on their skills and preferences.
...
| `experience_level` | Entry Level or Mid Level |
...
- Add a larger real-world job dataset
